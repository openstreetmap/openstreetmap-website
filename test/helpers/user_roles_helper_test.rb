...
class UserRolesHelperTest < ActionView::TestCase
  ...
  def test_role_icon_normal
    ...
    expected = <<~HTML.delete("\n")
      <img border="0" alt="This user is a moderator" title="This user is a moderator" src="/images/roles.svg#moderator" width="20" height="20" />
    HTML
    assert_dom_equal expected, icon

    icon = role_icon(create(:importer_user), "importer")
    expected = <<~HTML.delete("\n")
      <img border="0" alt="This user is a importer" title="This user is a importer" src="/images/roles.svg#importer" width="20" height="20" />
    HTML
    assert_dom_equal expected, icon
  end
  ...
  def test_role_icon_administrator
    ...
    expected = <<~HTML.delete("\n")
      ...
      <img border="0" alt="Grant moderator access" title="Grant moderator access" src="/images/roles.svg#blank_moderator" width="20" height="20" />
      </a>
    HTML
    assert_dom_equal expected, icon
    ...
    expected = <<~HTML.delete("\n")
      ...
      <img border="0" alt="Grant importer access" title="Grant importer access" src="/images/roles.svg#blank_importer" width="20" height="20" />
      </a>
    HTML
    assert_dom_equal expected, icon
    ...
    expected = <<~HTML.delete("\n")
      ...
      <img border="0" alt="Revoke moderator access" title="Revoke moderator access" src="/images/roles.svg#moderator" width="20" height="20" />
      </a>
    HTML
    assert_dom_equal expected, icon
    ...
    expected = <<~HTML.delete("\n")
      ...
      <img border="0" alt="Revoke importer access" title="Revoke importer access" src="/images/roles.svg#importer" width="20" height="20" />
      </a>
    HTML
    assert_dom_equal expected, icon
  end
  ...
  def test_role_icons_normal
    ...
    expected = <<~HTML.delete("\n")
      <img border="0" alt="This user is an administrator" title="This user is an administrator" src="/images/roles.svg#administrator" width="20" height="20" />
      <img border="0" alt="This user is a moderator" title="This user is a moderator" src="/images/roles.svg#moderator" width="20" height="20" />
      <img border="0" alt="This user is a importer" title="This user is a importer" src="/images/roles.svg#importer" width="20" height="20" />
    HTML
    assert_dom_equal expected, icons
  ...
  def test_role_icons_administrator
    ...
    expected = <<~HTML.delete("\n")
      ...
      <img border="0" alt="Grant administrator access" title="Grant administrator access" src="/images/roles.svg#blank_administrator" width="20" height="20" />
      </a>
      <a data-confirm="Are you sure you want to grant the role `moderator&#39; to the user `#{user.display_name}&#39;?" rel="nofollow" data-method="post" href="/user/#{ERB::Util.u(user.display_name)}/role/moderator/grant">
      <img border="0" alt="Grant moderator access" title="Grant moderator access" src="/images/roles.svg#blank_moderator" width="20" height="20" />
      </a>
    ...
    expected = <<~HTML.delete("\n")
      ...
      <img border="0" alt="Revoke administrator access" title="Revoke administrator access" src="/images/roles.svg#administrator" width="20" height="20" />
      </a>
