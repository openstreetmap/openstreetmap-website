  ...
  class MessagesControllerTest < ActionDispatch::IntegrationTest
    ...
    def test_create_success
      ...
      sender_token = create(:oauth_access_token,
                            ...
                            :scopes => %w[message_send message_consume])
      ...
      assert_equal msg.body_format, jsm["body_format"]
      assert_equal jsm["body"], msg.body
    end
    ...
    def test_show
      ...
      assert_select "message", :count => 1 do
        ...
        assert_select "[body_format='#{msg.body_format}']"
    ...
    def test_delete
      ...
      assert_not_nil jsm["sent_on"]
      assert_equal msg.message_read, jsm["message_read"]
      assert_not jsm["from_user_visible"]
      assert_not jsm["to_user_visible"]
      assert_equal msg.body_format, jsm["body_format"]
      assert_equal jsm["body"], msg.body
    end
