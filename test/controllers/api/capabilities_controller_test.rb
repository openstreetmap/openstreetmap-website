...
module Api
  class CapabilitiesControllerTest < ActionDispatch::IntegrationTest
    ...
    def test_capabilities
      ...
      assert_select "osm[version='#{Settings.api_version}'][generator='#{Settings.generator}']", :count => 1 do
        assert_select "api", :count => 1 do
          ...
          assert_select "user_preferences[key_maximum_length='255'][value_maximum_length='10000']", :count => 1
    ...
    def test_capabilities_json
      ...
      assert_equal 10_000, js["api"]["user_preferences"]["value_maximum_length"]
