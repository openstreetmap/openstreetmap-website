...
OSM.Directions = function (map) {
  ...
  const endpoints = [
    OSM.DirectionsEndpoint(map, $("input[name='route_from']"), "MARKER_GREEN", endpointDragCallback, endpointChangeCallback),
    OSM.DirectionsEndpoint(map, $("input[name='route_to']"), "MARKER_RED", endpointDragCallback, endpointChangeCallback)
  ];
