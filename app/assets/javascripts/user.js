...
$(document).ready(function () {
  ...
  let map, marker, deleted_lat, deleted_lon, deleted_home_name, homeLocationNameEndpoint, savedLat, savedLon;
  ...
  if ($("#map").length) {
    ...
    homeLocationNameEndpoint = OSM.HomeLocationNameEndpoint($("#home_lat"), $("#home_lon"), $("#home_location_name"));
    ...
    if ($("#map").hasClass("set_location")) {
      ...
      $("#home_location_name").on("input", function () {
        homeLocationNameEndpoint.dirty = true;
        clearDeletedText();
      ...
      if (lat && lon) {
        ...
        if (updateLocationName) {
          if (savedLat && savedLon && $("#home_location_name").val().trim()) {
            homeLocationNameEndpoint.updateHomeLocationName(false, savedLat, savedLon, homeLocationNameEndpoint.updateHomeLocationName);
