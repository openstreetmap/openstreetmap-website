...
function startExport(sidebarHtml) {
  ...
  $("#sidebar_title").html(i18n('export.start_rjs.export'));
...
function startDrag() {
  $("#drag_box").html(i18n('export.start_rjs.drag_a_box'));
...
function endDrag(bbox) {
  ...
  $("#drag_box").html(i18n('export.start_rjs.manually_select'));
}
...
function startMarker() {
  $("#add_marker").html(i18n('export.start_rjs.click_add_marker'));
...
function endMarker(event) {
  ...
  $("#add_marker").html(i18n('export.start_rjs.change_marker'));
  $("#marker_inputs").show();
...
function clearMarker() {
  ...
  $("#marker_lat").val("");
  $("#marker_inputs").hide();
  $("#add_marker").html(i18n('export.start_rjs.add_marker'));
...
function htmlUrlChanged() {
  ...
  var text = i18n('export.start_rjs.view_larger_map');
  var escaped = [];
