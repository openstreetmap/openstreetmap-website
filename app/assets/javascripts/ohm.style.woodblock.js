...
ohmVectorStyles.Woodblock = {
  ...
  "layers": [
    ...
    },
    {
      ...
      "layout": {"visibility": "visible"},
      "paint": {
        "line-color": "rgba(213, 203, 181, 1)",
        "line-dasharray": [3, 2],
        "line-width": {"stops": [[4, 0.25], [8, 1]]}
      }
    },
    {
      "id": "roads_subways",
    ...
    },
    {
      ...
      "layout": {"text-field": "{name}", "text-size": 11, "visibility": "none"},
      "paint": {
    ...
    },
    {
      ...
      "layout": {"icon-image": "power_tower-12", "visibility": "none"}
    },
    {
      "id": "points_airport",
      "type": "symbol",
      ...
      "layout": {"icon-image": "airport-18", "visibility": "none"}
    },
    {
      "id": "transport_points",
      "type": "symbol",
    ...
    },
    {
      ...
      "layout": {"icon-image": "place_of_worship-18", "visibility": "none"}
    },
    {
      "id": "points_religion",
      "type": "symbol",
      ...
      "source-layer": "buildings",
      "filter": ["all"],
      "layout": {"icon-image": "{religion}-18", "visibility": "none"}
    },
    {
      ...
      "source-layer": "landuse_areas",
      "minzoom": 16,
      "layout": {"icon-image": "{type}-18", "visibility": "none"}
    },
    {
      "id": "points_acra",
      "type": "symbol",
      ...
      "layout": {"icon-image": "acra-18", "visibility": "none"}
    },
    {
      "id": "points_oxfam",
      "type": "symbol",
      ...
      "layout": {"icon-image": "oxfam-18", "visibility": "none"}
    },
    {
