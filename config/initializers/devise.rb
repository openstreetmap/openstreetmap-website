...
Devise.setup do |config|
  ...
  # config.pepper = 'bdb80f11592facb00d055413294f9e48798d46956c9d1fe724fab37124b560f82056d88b83d1d33a97b231288f692de08fb55385d06d8078221193cd6e2774e6'
  ...
  #   warden_config.default_strategies(scope: :user).unshift :some_external_strategy
    ...
    warden_config.failure_app = Devise::OsmFailureApp
  end
