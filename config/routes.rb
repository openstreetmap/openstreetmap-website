OpenStreetMap::Application.routes.draw do
  ...
  get "/relation/:id/members" => "relation_members#show", :id => /\d+/, :as => :relation_member
  ...
  get "/relation/:id/history/:version/members" => "old_relation_members#show", :id => /\d+/, :version => /\d+/, :as => :old_relation_member
